...
test('Load viewer with URL params 1', async ({ page }) => {
  ...
  await expect(page.locator('#viewport-1')).toContainText('Billede af området omkring koordinat 674480 Ø, 6133108 N set fra syd.')
})
...
test('Load viewer with URL params 2', async ({ page }) => {
  ...
  await expect(page.locator('#viewport-1')).toContainText('Billede af området omkring koordinat 642577 Ø, 6136802 N set fra syd.')
})
...
test('Load viewer with URL params 3', async ({ page }) => {
  ...
  await expect(page.locator('#viewport-1')).toContainText('Billede af området omkring koordinat 591822 Ø, 6104315 N set fra syd.')
})
...
test('Load viewer with URL params 4', async ({ page }) => {
  ...
  await expect(page.locator('#viewport-1')).toContainText('Billede af området omkring koordinat 594649 Ø, 6102975 N set fra syd.')
})
...
test('Load viewer with URL params 5', async ({ page }) => {
  ...
  await expect(page.locator('#viewport-1')).toContainText('Billede af området omkring koordinat 448601 Ø, 6190598 N set fra syd.')
})
...
test('Load viewer with many parcels', async ({ page }) => {
  ...
  await expect(page.locator('#viewport-1')).toContainText('Billede af området omkring koordinat 519999 Ø, 6265347 N set fra syd.')
})
